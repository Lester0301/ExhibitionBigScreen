...
//         },
      ...
      var totalData=[
        ...
        },
        {
          ...
          "Status": 1,
          "Ratio": 0.8719901634045184,
          "kWh": 189200.134277403,
          "TotalkWh": 46573999.3286133,
          "MonthkWh": 2364299.731445402,
          "YearkWh": 12061199.5635987,
          "InstalledCapacity": 34.95256,
          "Province": "河南",
          "City": "焦作市",
          "County": "马村区",
          "Days": 564,
        ...
        },
        {
          ...
          "Ratio": 0.8213031057098755,
          "kWh": 227700.8056641,
          "TotalkWh": 62858398.5900879,
          "MonthkWh": 2699403.222656196,
          "YearkWh": 14425298.187255897,
          "InstalledCapacity": 40.14623,
          "Province": "河南",
          "City": "安阳市",
          "County": "滑县",
          "Days": 449,
      ...
      var obg={};var aaa=[];var c=0;var t=0;

      $.each(totalData,function(key,item){
        //console.log(key,item.Id,item.Province)
        if(item["Province"]){
          if(obg[item.Province]){
            obg[item.Province]+=1;
          }else{
            obg[item.Province]=1;
          }
        }
        if(item["Province"]=="黑龙江"){
          c++;
        }
        //console.log(item.Province)
      })

      console.log(5234,obg)
      $.each(obg,function(key,item){
        t=t+item.value;
      })
      //console.log(totalData.length,eastData.length,northData.length,centerData.length,westData.length,southData.length);

    var cat1=[],cat2=[],cat3=[];
    var dt1=[],dt2=[],dt3=[];
    var bacV1=[],bacV2=[],bacV3=[];

    // for(var i=0;i<66;i++){
    //   if(i<22){
    //     cat1.push(ratio_data[i].Name);
    //     dt1.push((ratio_data[i].Ratio*100).toFixed(1));
    //     bacV1.push(100);
    //   }else if(i<44){
    //     cat2.push(ratio_data[i].Name);
    //     dt2.push((ratio_data[i].Ratio*100).toFixed(1));
    //     bacV2.push(100);
    //   }else{
    //     cat3.push(ratio_data[i].Name);
    //     dt3.push((ratio_data[i].Ratio*100).toFixed(1));
    //     bacV3.push(100);
    //   }
    // }

    // var tog=0,ratioTog=null;
    // var chart = echarts.init(document.getElementById('right1_con'));


    function drawEfficient(cat,dt,bacV){
      var option = {
        title: {
          text: '',
          subtext: ''
        ...
        tooltip: {
          ...
          formatter: function (params) {
            return "<p style='text-align:center;line-height:14px;'>" + params[0].name + "</p><p style='line-height:14px;'>发电效率：" + params[0].data + "%</p>"
          }
        },
        legend: {
          show:false,
